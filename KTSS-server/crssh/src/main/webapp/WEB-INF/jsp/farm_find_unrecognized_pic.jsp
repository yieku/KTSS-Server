...
<body>
    ...
    <div class="mainbg">
        <div class="mainwebw">
            ...
            <div >
                <div class='mb10'><table style='width:100%;'><tr><td class='tdstu'><a href="getAutoRecognizedPictures.do?id=${username}" class='ablock'>程序识别记录</a></td><td class='tdstu'><a href='getExpertRecognizedPictures.do?id=${username}'  class='ablock'>专家鉴定记录</a></td><td class='tdstu tdstubg'><a href='getUnrecognizedPictures.do?id=${username}'  class='ablock'>未能识别记录</a></td></tr></table></div><div  class='item_list infinite_scroll'></div>
                      
                  <c:forEach var="cls" items="${farm_unrecognized_photos}">    
	               <div class="img">
                    <a  href="sub6.do?id=${cls.getPictureID()}">
                       <img src=<%=basePath%>${cls.getPictureURL()} alt="Ballade" height=160px>
                     </a>
                    <div class="desc">${cls.getPlantName()}</div>
                   </div>
