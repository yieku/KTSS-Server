...
<body class="templatemo-bg-image-1">
	...
	try{
	state=session.getAttribute(WebConstants.login_state).toString();
    str=session.getAttribute(WebConstants.login_message).toString();
	...
	if(state.equals("1")||state.equals("2")||state.equals("3")||state.equals("4")||state.equals("5"))
    {
