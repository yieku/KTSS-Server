   ...
   <script>
    ...
    <div class="mainbg">
        <div class="mainwebw">
            ...
            <div>
                <div class='mb10'><table style='width:100%;'><tr><td class='tdstu tdstubg'><a href="getAutoRecognizedPictures.do?id=${username}" class='ablock'>程序识别记录</a></td><td class='tdstu'><a href='getExpertRecognizedPictures.do?id=${username}'  class='ablock'>专家鉴定记录</a></td><td class='tdstu'><a href='getUnrecognizedPictures.do?id=${username}'  class='ablock'>未能识别记录</a></td></tr></table></div><div  class='item_list infinite_scroll'></div>
                   
                   
                   <c:forEach var="cls" items="${auto_recognized_photos}">
	               <div class="img">
                    <a  href="sub4.do?id=${cls.getPictureID()}">
