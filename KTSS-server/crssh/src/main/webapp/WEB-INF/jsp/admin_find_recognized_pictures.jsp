       ...
       <tr height="30">
        ...
        <c:forEach var="cls" items="${recognized_photos}">
            <tr height="30">
              ...
              <td align="center" class="data">
              <c:out value="${cls.getRecognizedBy() }" />
              </td>
              
              <td align="center" class="data">
              <c:out value="${cls.getAccuracyRate() }" />
              </td>
              ...
              <td align="center" class="data">
              <a href="showRecognizedPicture.do?id=${cls.getPictureID()} ">查看</a>
              </td>
              
              <td align="center" class="data">
              <a href="deletePicture.do?id=${cls.getPictureID()}&type=<%="1"%> ">删除</a>
              </td>
           </tr>
         </c:forEach>    
