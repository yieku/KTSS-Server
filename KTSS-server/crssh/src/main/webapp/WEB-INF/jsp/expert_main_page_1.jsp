   ...
   <div class="top1">
    ...
    <div class="mainbg">
        <div class="mainwebw">
            ...
            <div class="mt20">
                <div class='mb10'><table style='width:100%;'><tr><td class='tdstu tdstubg'><a href="expertListAllUnRecognizedPhotos.do"  class='ablock'>未识别记录</a></td><td class='tdstu'><a href="expertListAllRecognizedPhotos.do"   class='ablock'>已识别记录</a></td></tr></table></div><div  class='item_list'></div>
                      
                   <c:forEach var="cls" items="${unrecognized_photos}">
	                <div class="img">
                    <a  href="sub.do?id=${cls.getPictureID()}&url=${cls.getPictureURL()}">
